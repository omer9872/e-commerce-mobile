...
const SettingsScreen = () => {
  ...
  const togglePushNotifications = () => setPushNotifications((previousState) => !previousState)
  ...
  const toggleDarkMode = () => {
    ...
    Alert.alert("Feature Not Implemented", "Dark mode switching is not yet implemented.")
  }
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.section}>
        ...
        <TouchableOpacity style={styles.button} onPress={handleDeleteAccount}>
          ...
          <Text style={[styles.buttonText, { color: colors.error }]}>Delete Account</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  )
